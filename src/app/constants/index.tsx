...
export const endPoint: Models.EndPoint = {
	url: 'https://robincanlas-server-typescript-docker.onrender.com/covid19',
};

export const CONSTANTS = {
	covid19Endpoint: 'https://robincanlas-server-typescript-docker.onrender.com/covid19/list/jhucsse',
