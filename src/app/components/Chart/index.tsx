...
export const ChartComponent: React.FC<Chart.Props> = ({ dailyData = [], isLoading = true, actions = ChartActions }: Chart.Props) => {
	React.useEffect(() => {
		actions.getDaily();
	}, []);
...
const mapStateToProps = (state: RootState): Pick<Chart.Props, 'dailyData' | 'isLoading'> => {
	return {
